...
@implementation SpeedometerNeedle
...
- (void)initialize {
	...
	textLabel_ = [[UILabel alloc] initWithFrame:CGRectMake(0, 6.5 * self.frame.size.height / 10.0, self.frame.size.width, self.frame.size.height / 10.0)];
	...
	needle_ = [[SpeedometerNeedle alloc] init];
